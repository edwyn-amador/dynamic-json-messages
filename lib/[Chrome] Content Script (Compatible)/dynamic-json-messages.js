  ...
  if (context.isChromeExt)
    chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
      if (request.DJM_IsJSONFileLoaded) sendResponse(jsonString !== "");
        ...
        const { key, response, replaceTemplate, excludeTemplate, mergeTemplate, lock } = request.data;
        _Run(key, { response, replaceTemplate, excludeTemplate, mergeTemplate, lock })
